...
export type PacienteWhereInput = {
  ...
  CI?: Prisma.IntFilter<"Paciente"> | number
  ...
  direccion?: Prisma.StringFilter<"Paciente"> | string
...
export type PacienteScalarWhereWithAggregatesInput = {
  ...
  CI?: Prisma.IntWithAggregatesFilter<"Paciente"> | number
  ...
  direccion?: Prisma.StringWithAggregatesFilter<"Paciente"> | string
...
export type PacienteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"CI" | "nombre" | "apellido" | "fecha_nacimiento" | "direccion" | "telefono" | "email", ExtArgs["result"]["paciente"]>
...
export interface PacienteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `CI`
   * const pacienteWithCIOnly = await prisma.paciente.findMany({ select: { CI: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Pacientes and only return the `CI`
   * const pacienteWithCIOnly = await prisma.paciente.createManyAndReturn({
   *   select: { CI: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Pacientes and only return the `CI`
   * const pacienteWithCIOnly = await prisma.paciente.updateManyAndReturn({
   *   select: { CI: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PacienteFieldRefs {
  readonly CI: Prisma.FieldRef<"Paciente", 'Int'>
